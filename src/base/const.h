...
const char DEEPIN_HOME_CHANNEL_PUBLIC[] = "p";  // 公共通知渠道
const char DEEPIN_HOME_TOPIC_NEWS[] = "n";      // 新闻通知
const char DEEPIN_HOME_TOPIC_QUESTIONS[] = "q"; // 调查问卷

#endif // DEEEPIN_HOME_CONSTS_H
