...
QString toStringValue(const DHObject &value);
QString toStringValue(const DHEnum &value);
QString toStringValue(const DHHttpFileElement &value);
...
QJsonValue toJsonValue(const DHObject &value);
QJsonValue toJsonValue(const DHEnum &value);
QJsonValue toJsonValue(const DHHttpFileElement &value);
...
bool fromStringValue(const QString &inStr, DHObject &value);
bool fromStringValue(const QString &inStr, DHEnum &value);
bool fromStringValue(const QString &inStr, DHHttpFileElement &value);
...
bool fromJsonValue(DHObject &value, const QJsonValue &jval);
bool fromJsonValue(DHEnum &value, const QJsonValue &jval);
bool fromJsonValue(DHHttpFileElement &value, const QJsonValue &jval);
